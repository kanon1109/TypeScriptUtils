class CubicBezierCurveTest 
{
    ...
    public constructor(stage:egret.Stage)
    {
		...
		let p3:egret.Point = new egret.Point(530, 240);
		...
		let position:egret.Point = this.cbc.getPoint(0);
	...
	{
		let position:egret.Point = this.cbc.getPoint(this.o.value);
	...
	private onStageMouseMove(event:egret.TouchEvent):void 
	{
		...
		let p3:egret.Point = new egret.Point(this.sp3.x, this.sp3.y)
