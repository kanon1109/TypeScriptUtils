...
var QuadraticBezierCurveTest = (function () {
    function QuadraticBezierCurveTest(stage) {
        this.stage = stage;
        ...
        var position = this.qbc.getPoint(0);
    ...
    QuadraticBezierCurveTest.prototype.updateHandler = function () {
        var position = this.qbc.getPoint(this.o.value);
    ...
    QuadraticBezierCurveTest.prototype.completeHandler = function () {
        if (this.tw) {
    ...
    QuadraticBezierCurveTest.prototype.onMouseUpHandler = function (event) {
        this.curSp = null;
        this.stage.removeEventListener(egret.TouchEvent.TOUCH_MOVE, this.onStageMouseMove, this);
    };
    QuadraticBezierCurveTest.prototype.onMouseDownHandler = function (event) {
        this.curSp = event.target;
        this.stage.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.onStageMouseMove, this);
    };
    QuadraticBezierCurveTest.prototype.onStageMouseMove = function (event) {
    ...
    return QuadraticBezierCurveTest;
}());
__reflect(QuadraticBezierCurveTest.prototype, "QuadraticBezierCurveTest");
//# sourceMappingURL=QuadraticBezierCurveTest.js.map