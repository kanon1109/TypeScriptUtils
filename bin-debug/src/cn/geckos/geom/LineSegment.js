...
(function (cn) {
    ...
    (function (geckos) {
        ...
        (function (geom) {
            ...
            //
            /////////////////////////////////////////
            var MathUtil = cn.geckos.utils.MathUtil;
            var LineSegment = (function () {
                ...
                var __egretProto__ = LineSegment.prototype;
                /**
                 * 获得该线段的截距(和y轴相交的点的y值)
                 * @return
                 */
                __egretProto__.getIntercept = function () {
                 ...
                 * @return
                 */
                __egretProto__.getLineSlope = function () {
                 ...
                 * @return
                 */
                __egretProto__.toMathString = function () {
                    var slope = this.getLineSlope();
                 ...
                 * @return
                 */
                __egretProto__.isHorizontal = function () {
                 ...
                 * @return
                 */
                __egretProto__.isVertical = function () {
                 ...
                 * @return
                 */
                __egretProto__.isPerpendicular = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.isParallel = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.angleBetween = function (line, degrees) {
                 ...
                 * @return
                 */
                __egretProto__.getSibling = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.getSiblingLine = function () {
                 ...
                 * @return
                 */
                __egretProto__.isInLineTrack = function (point) {
                    var slope = this.getLineSlope();
                 ...
                 * @return
                 */
                __egretProto__.getLineObj = function () {
                 ...
                 * @return
                 */
                __egretProto__.hasIntersection = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.getRelation = function (line) {
                    ...
                    if (this.getLineObj()["slope"] == line.getLineObj()["slope"] && this.getLineObj()["intercept"] == line.getLineObj()["intercept"]) {
                ...
                //TODO
                __egretProto__.isEqual = function (line) {
                    return (this.startPoint.equals(line.startPoint) && this.endPoint.equals(line.endPoint)) || (this.startPoint.equals(line.endPoint) && this.endPoint.equals(line.startPoint));
                };
                /**
                 * 获得2条线段的可能的相交点
                 * @param	line
                 * @return
                 */
                __egretProto__.getIntersectionPoint = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.isIntersection = function (line) {
                 ...
                 * @return
                 */
                __egretProto__.isContainPoint = function (point) {
                    ...
                    if ((spTempDx * epTempDy - epTempDx * spTempDy) > .0000001)
                        return false;
                    //判断是否在线段上
                    if ((point.x > this.startPoint.x && point.x > this.endPoint.x) || (point.x < this.startPoint.x && point.x < this.endPoint.x))
                        return false;
                    if ((point.y > this.startPoint.y && point.y > this.endPoint.y) || (point.y < this.startPoint.y && point.y < this.endPoint.y))
                        return false;
                    return true;
                };
            ...
            LineSegment.prototype.__class__ = "cn.geckos.geom.LineSegment";
